...
public class ConsumerFunctionInterface {
    public static void main(String[] args) {
        ...
        //when i want to work with a list of Strings
        ...
        // This exmple is on consumer and functional interface
        List<String>elements=new ArrayList<>();

        elements.addAll(Arrays.asList("Java","Java","Cybertek","Pyton","Pyton"));

        List<String>duplicatedElements=new ArrayList<>();

        Predicate<String>isDuplicated=p-> Collections.frequency(elements,p)>1;

        elements.forEach(s->{  // consumer interface
            if(isDuplicated.test(s))  // Predicate interface
        ...
        // we need to change only the type to get the alpa.. des order
